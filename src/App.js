        ...
        <Navbar className="border-bottom s-navbar" expand="lg">
          ...
          <Navbar.Collapse id="navbar-toggle">
            <Nav className="ml-auto">
              ...
              <Badge variant="light" className="nav-link" style={{paddingTop:"15px"}}><a style={{color:"gray"}} href="https://docs.google.com/document/d/1k3QMn_XeigwSdIjmDWHl84-_EBCMQ16u96NxXKUCMII/edit?usp=sharing">Resume </a> </Badge>
